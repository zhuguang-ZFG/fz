...
# Official MCP stdio server: install requirements-mcp.txt, then see docs/MCP_SERVER.md
...
# R22 CI: .github/workflows/host_sil.yml (Windows quick default; Linux R32 parked/opt-in)
